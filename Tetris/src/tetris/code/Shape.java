...
class Shape {
	...
	protected Shape(int x, int y, String type, int type_no, int rot_no, String code) {
		this.shape_id = Tetris.tetrisVariables.get_shape_cnt();
	...
	protected String get_shape_type() {
		return this.shape_type;
	}

	protected int get_shape_type_no() {
		return this.shape_type_no;
	}

	protected int get_shape_rotation_no() {
		return this.shape_rotation_no;
	}

	protected String get_shape_code() {
		return this.shape_code;
	}

	protected long get_shape_id() {
		return this.shape_id;
	}

	protected boolean get_shape_active() {
		return this.active;
	}

	protected int get_shape_loc_X() {
		return this.loc_x;
	}

	protected int get_shape_loc_Y() {
		return this.loc_y;
	}

	protected int get_shape_start_loc_X() {
		return this.start_loc_x;
	}

	protected int get_shape_start_loc_Y() {
		return this.start_loc_y;
	}

	protected int get_shape_end_loc_X() {
		return this.end_loc_x;
	}

	protected int get_shape_end_loc_Y() {
		return this.end_loc_y;
	}

	// setter methods for shape objects
	protected void set_shape_type(String type) {
		this.shape_type = type;
	}

	protected void set_shape_code(String code) {
		this.shape_code = code;
	}

	protected void set_shape_id(long id) {
		this.shape_id = id;
	}

	protected void set_shape_active(boolean act) {
		this.active = act;
	}

	protected void set_shape_loc_X(int x) {
		this.loc_x = x;
	}

	protected void set_shape_loc_Y(int y) {
		this.loc_y = y;
	}

	protected void set_shape_start_loc_X(int x) {
		this.start_loc_x = x;
	}

	protected void set_shape_start_loc_Y(int y) {
		this.start_loc_y = y;
	}

	protected void set_shape_end_loc_X(int x) {
		this.end_loc_x = x;
	}

	protected void set_shape_end_loc_Y(int y) {
		this.end_loc_y = y;
	}
